    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        {appointments.map((appointment) => (
          <div
            key={appointment.id}
            className="flex items-center p-3 border border-gray-100 rounded-md hover:bg-gray-50"
          >
            ...
            <div
              className={`text-xs px-2 py-1 rounded-full ${statusClasses[appointment.status]}`}
            >
